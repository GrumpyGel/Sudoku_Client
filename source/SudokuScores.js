...
Usage : let SudokuScores = new SudokuScores()
...
Usage : let Credentials = new ss_Credentials()
...
Methods:
    ...
    Load(Credentials) : Load the ss_Credentials property data from the passed Credentials object.
...
Methods:
    ...
    Load(Times) : Load the ss_Times property data from the passed Times object.
    ...
    static GetCombined(ServerTimes, LocalTimes) : Returns a new ss_Times object being the combined totals of the Server and Local ss_Times.
...
Usage : let Level = new ss_Level(Level)
...
Methods:
    Load(Level) : Load the ss_Level property data from the passed Level object.
...
Usage : let Region = new ss_Region()
...
class ss_Level {
    ...
    static ToMinutes(p_Seconds) {
        let i_Minutes = Math.floor(p_Seconds / 60);
        let i_Seconds = p_Seconds - (i_Minutes * 60);
...
class SudokuScores {
    ...
    GetCombined(p_Level) {
        let i_Combined = new ss_Level(p_Level);
